                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group custom-control-inline" style="width:100%">
                                                                ...
                                                                <input type="text" name="date_of_issue" class="form-control datepicker" value=''>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group custom-control-inline" style="width:100%">
                                                                ...
                                                                <input type="text" name="expiration_date" class="form-control datepicker" value='' >
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                         <div class="form-group">
                                                            ...
                                                            <div class="form-group custom-control-inline" style="width:100%">
                                                                ...
                                                                <input type="text" name="delivery_date" class="form-control datepicker" value=''>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group custom-control-inline" style="width:100%">
                                                                <input type="text" name="note" class="form-control tutor_input" value="" >
                                                                @if ($errors->has('note'))
                                                                <span class="red" role="alert">
